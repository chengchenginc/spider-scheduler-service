...
(function(win, $) {
    ...
    jobManager.delJob = function(name, group, callback) {
        api.get(jobManager.host + "/delete", {
            name: name,
            group: group
        }, callback);
    };
    ...
    jobManager.triggerJob = function(name, group, callback) {
        api.get(jobManager.host + "/trigger", {
            name: name,
            group: group
        }, callback);
    };

    jobManager.addJob = function(data, callback) {
    ...
    jobManager.restartJob = function(name, group, callback) {
        api.get(jobManager.host + "/restart", {
            name: name,
            group: group
        }, callback);
    };
